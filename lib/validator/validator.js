...
/**
 * Generates a generic asyncronous object validator
 * @class Validator
 * @param {Object} options
 * @param {String} options.name The internal validator name
 * @param {String} options.type Then internal validator type
 * @param {String} file The input file name
 * @requires @helpdotcom/build-ast
 * @requires help-gen/lib/prop
 * @requires help-gen/lib/prop
 * @requires help-gen/lib/is-helper
 * @requires help-gen/lib/validator/types
 **/
...
module.exports = class Validator {
  ...
  warn(message, context) {
    const fullMessage = `${this.name} -> ${context.path}: ${message}`
    if (this.warningsFailGenerate) {
